...
?>
    ...
    <div style="background-image: url(<?php echo get_template_directory_uri() . '/images/contact-hero-banner-1.jpg'; ?>)"; class="relative w-full h-[400px] lg:h-[600px] -z-20 bg-center bg-cover bg-no-repeat before:absolute before:top-0 before:left-0 before:bg-neutral-800/60 before:w-full before:h-full before:-z-10">
    ...
    <section class="xl:-mt-16">
        <div class="grid grid-cols-12">
                ...
                <div class="px-6 py-8 text-center md:px-24 lg:px-12 xl:px-28">                    
                    <div>
                        <h2 class="text-3xl leading-snug uppercase md:text-5xl md:leading-snug lg:text-6xl lg:leading-snug comp-text-dark comp-heading-font">
                            Visit Duzo in <span class="text-primary">Al Zahia, Sharjah</span>
                        </h2>
                    </div>
                    
                    <div class="my-12 mt-8 lg:mt-12 lg:my-14">
                        <p class="leading-7 text-black xl:leading-7 xl:text-base">
                            Looking for the best Asian restaurant near you? Duzo is located in the heart of Al Zahia, Sharjah. Contact us for reservations or visit us today for a warm dining experience.
                            <br />
                            <br />
            ...
            <div class="col-span-12 lg:col-span-6 xl:-mt-12">
                <div style="background-image: url(<?php echo get_template_directory_uri() . '/images/contact-content-image-1.jpg'; ?>)"; class="w-full h-[350px] md:h-[450px] lg:h-full bg-center bg-no-repeat bg-cover"></div>
            </div>
        </div>
    </section>
